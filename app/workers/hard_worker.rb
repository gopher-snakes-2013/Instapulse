class HardWorker
  ...
  recurrence { minutely.second_of_minute(HardWorker.second_counter(1)) }
...
# say sidekiq in console to execute worker
...
# ------------------------------
# Data Cleaner: schedule daily

# delete data if instagram_picture.time < Time.now.to_i - 604800 (week)
